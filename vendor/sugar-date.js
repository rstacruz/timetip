// This is a custom build of Sugar.js that only has a selected amount of Date
// extensions needed by timetip.
...
(function() {
  ...
  buildFormatTokens();
  // buildFormatShortcuts(); [disabled]
  // buildAsianDigits(); [disabled]
  // buildRelativeAliases(); [disabled]
  // buildUTCAliases(); [disabled]
  setDateProperties();
